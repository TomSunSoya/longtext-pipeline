...
class PartialResult:
    ...
    def merge_with_other(self, other: 'PartialResult') -> 'PartialResult':
        ...
        return PartialResult(
            ...
            data=self.data if hasattr(other, 'data') and other.data is not None and len(other.data) > len(self.data) 
                    else self.data,
    ...
    def get_full_summary(self) -> dict:
        ...
        return {
            ...
            "overall_stats": {
                ...
                "total_warning_count": sum(len(warn_list) for warn_list in self.warnings.values()),
            },
