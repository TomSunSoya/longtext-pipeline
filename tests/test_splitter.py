...
from src.longtext_pipeline.models import Part
from src.longtext_pipeline.splitter import TextSplitter
from src.longtext_pipeline.utils.token_estimator import estimate_tokens_for_part, estimate_total_tokens
...
class TestTextSplitter:
    ...
    def test_token_estimator_integration(self):
        ...
        splitter = TextSplitter(chunk_size=100)
        text = "This is a sample text that will be split for token estimation testing. " * 5
    ...
    def test_preprocessing_integration(self):
        ...
        assert "\n\n\n" not in cleaned  # Multiple consecutive blank lines should be collapsed
    ...
    def test_preprocessing_disabled_flag(self):
        ...
        parts_enabled = splitter.split_text(dirty_content, preprocess=True, chunk_size=50)
        
        # Test with preprocess disabled
        parts_disabled = splitter.split_text(dirty_content, preprocess=False, chunk_size=50)
