...
class StageFailedError(PipelineError):
    ...
    def __init__(self, stage_name: str, errors: List[Exception], partial_result: Any = None):
...
# Import continuation errors for easy access
from .continuation import PartialResult, ErrorAggregator
