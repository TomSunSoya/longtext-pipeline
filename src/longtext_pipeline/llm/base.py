...
class LLMClient(ABC):
    ...
    Expected Behavior:
        - Implementations must handle timeout, retry, and error propagation
        - Methods should raise descriptive exceptions on failure (see errors.py)
        - All methods are synchronous and block until completion or error
